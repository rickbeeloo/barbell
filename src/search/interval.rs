...
mod tests {
    ...
    //     let matches = vec![
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd),
    //         create_match(30, 40, 0, 10, BarcodeType::Fbar, 4, 2, "test2", Strand::Fwd),
    //     ];
    //     let result = collapse_overlapping_matches(&matches, 0.5);
    ...
    //     let matches = vec![
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd),
    //         create_match(15, 25, 0, 10, BarcodeType::Fbar, 4, 2, "test2", Strand::Fwd), // Better cost
    //     ];
    //     let result = collapse_overlapping_matches(&matches, 0.5);
    //     assert_eq!(result.len(), 1);
    ...
    //     let matches = vec![
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd),
    //         create_match(15, 25, 0, 10, BarcodeType::Fbar, 4, 2, "test2", Strand::Fwd),
    //         create_match(40, 50, 0, 10, BarcodeType::Fbar, 3, 1, "test3", Strand::Fwd),
    //         create_match(45, 55, 0, 10, BarcodeType::Fbar, 6, 4, "test4", Strand::Fwd),
    //     ];
    //     let result = collapse_overlapping_matches(&matches, 0.5);
    //     assert_eq!(result.len(), 2);
    ...
    // #[test]
    // fn test_is_overlap() {
    //     let match1 = create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd);
    //     let match2 = create_match(15, 25, 0, 10, BarcodeType::Fbar, 4, 2, "test2", Strand::Fwd);
    ...
    //     // Test non-overlapping matches
    //     let match3 = create_match(30, 40, 0, 10, BarcodeType::Fbar, 3, 1, "test3", Strand::Fwd);
    //     assert!(!is_overlap(&match1, &match3, 0.5));
    //     assert!(!is_overlap(&match3, &match1, 0.5));

    //     // Test adjacent matches (no overlap)
    //     let match4 = create_match(20, 30, 0, 10, BarcodeType::Fbar, 2, 1, "test4", Strand::Fwd);
    //     assert!(!is_overlap(&match1, &match4, 0.5));

    //     // Test threshold behavior
    //     let match5 = create_match(18, 22, 0, 10, BarcodeType::Fbar, 1, 1, "test5", Strand::Fwd);
    ...
    //     let matches = vec![
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd),
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 4, 2, "test2", Strand::Fwd), // Lower cost
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 6, 4, "test3", Strand::Fwd),
    //     ];
    //     let result = select_best_match(matches);
    ...
    //     let matches = vec![
    //         create_match(10, 20, 0, 10, BarcodeType::Rbar, 1, 1, "test1", Strand::Fwd),
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 5, "test2", Strand::Fwd), // Lower type
    //     ];
    //     let result = select_best_match(matches);
    ...
    //     let matches = vec![
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd),
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test2", Strand::Fwd),
    //     ];
    //     let result = select_best_match(matches);
    ...
    //     let match1 = create_match(10, 10, 0, 0, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd);
    //     let match2 = create_match(10, 10, 0, 0, BarcodeType::Fbar, 4, 2, "test2", Strand::Fwd);
    //     assert!(!is_overlap(&match1, &match2, 0.5)); // No overlap for zero-length

    //     // Test matches with very small overlap
    //     let match1 = create_match(10, 12, 0, 2, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd);
    //     let match2 = create_match(11, 13, 0, 2, BarcodeType::Fbar, 4, 2, "test2", Strand::Fwd);
    ...
    //     let match1 = create_match(10, 20, 0, 10, BarcodeType::Fbar, 5, 3, "test1", Strand::Fwd);
    //     let match2 = create_match(15, 25, 0, 10, BarcodeType::Fbar, 4, 2, "test2", Strand::Rc);
    ...
    //     let matches = vec![
    //         create_match(30, 40, 0, 10, BarcodeType::Fbar, 5, 3, "test3", Strand::Fwd),
    //         create_match(10, 20, 0, 10, BarcodeType::Fbar, 4, 2, "test1", Strand::Fwd),
    //         create_match(20, 30, 0, 10, BarcodeType::Fbar, 3, 1, "test2", Strand::Fwd),
    //     ];
    //     let result = collapse_overlapping_matches(&matches, 0.5);
